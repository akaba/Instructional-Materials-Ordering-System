<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="InstructionalMaterials.ShoppingCart" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
      <td>
        <asp:Button ID="UpdateBtn" runat="server" Text="Update Chart" OnClick="UpdateBtn_Click" />
      </td>
      <td>
          &nbsp;
